(function () {
    ...
    const COPY = {
        it: { launcher: 'Chat', title: 'Assistenza Eurolicenze', intro: 'Come possiamo aiutarti?', name: 'Nome', email: 'Email', placeholder: 'Scrivi un messaggio…', sendHint: 'Premi Invio per inviare, Maiuscolo+Invio per andare a capo.', send: 'Invia', loading: 'Connessione…', offline: 'Chat non disponibile. Scrivici a Desk@eurolicenze.com', retry: 'Riconnessione…', error: 'Messaggio non inviato. Riprova.', close: 'Chiudi chat', open: 'Apri la chat di assistenza', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'Connessione…', stReconnecting: 'Riconnessione…', stError: 'Non disponibile', noticeOnline: 'Assistenza online. Di solito rispondiamo in pochi minuti.', noticeOffline: 'Siamo offline (assistenza Lun–Sab, 08:00–19:00). Lascia nome, email e un messaggio: ti ricontattiamo appena possibile.' },
        en: { launcher: 'Chat', title: 'Eurolicenze support', intro: 'How can we help?', name: 'Name', email: 'Email', placeholder: 'Write a message…', sendHint: 'Press Enter to send, Shift+Enter for a new line.', send: 'Send', loading: 'Connecting…', offline: 'Chat unavailable. Email Desk@eurolicenze.com', retry: 'Reconnecting…', error: 'Message not sent. Please retry.', close: 'Close chat', open: 'Open the support chat', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'Connecting…', stReconnecting: 'Reconnecting…', stError: 'Unavailable', noticeOnline: 'Support is online. We usually reply within minutes.', noticeOffline: 'We are offline (support hours Mon–Sat, 08:00–19:00 CET/CEST). Leave your name, email and a message: we will get back to you.' },
        fr: { launcher: 'Chat', title: 'Assistance Eurolicenze', intro: 'Comment pouvons-nous vous aider ?', name: 'Nom', email: 'E-mail', placeholder: 'Écrivez un message…', sendHint: 'Appuyez sur Entrée pour envoyer, Maj+Entrée pour un retour à la ligne.', send: 'Envoyer', loading: 'Connexion…', offline: 'Chat indisponible. Écrivez à Desk@eurolicenze.com', retry: 'Reconnexion…', error: 'Message non envoyé. Réessayez.', close: 'Fermer le chat', open: 'Ouvrir le chat d’assistance', stOnline: 'En ligne', stOffline: 'Hors ligne', stConnecting: 'Connexion…', stReconnecting: 'Reconnexion…', stError: 'Indisponible', noticeOnline: 'Assistance en ligne. Nous répondons en quelques minutes.', noticeOffline: 'Nous sommes hors ligne (assistance Lun–Sam, 08:00–19:00 CET/CEST). Laissez nom, e-mail et un message : nous vous recontacterons.' },
        de: { launcher: 'Chat', title: 'Eurolicenze Support', intro: 'Wie können wir helfen?', name: 'Name', email: 'E-Mail', placeholder: 'Nachricht schreiben…', sendHint: 'Eingabetaste zum Senden, Umschalt+Eingabetaste für einen Zeilenumbruch.', send: 'Senden', loading: 'Verbindung…', offline: 'Chat nicht verfügbar. E-Mail: Desk@eurolicenze.com', retry: 'Verbindung wird wiederhergestellt…', error: 'Nachricht nicht gesendet. Erneut versuchen.', close: 'Chat schließen', open: 'Support-Chat öffnen', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'Verbindung…', stReconnecting: 'Neuverbindung…', stError: 'Nicht verfügbar', noticeOnline: 'Support ist online. Wir antworten meist in wenigen Minuten.', noticeOffline: 'Wir sind offline (Support Mo–Sa, 08:00–19:00 Uhr CET/CEST). Hinterlassen Sie Name, E-Mail und eine Nachricht, wir melden uns.' },
        es: { launcher: 'Chat', title: 'Soporte Eurolicenze', intro: '¿Cómo podemos ayudarte?', name: 'Nombre', email: 'Email', placeholder: 'Escribe un mensaje…', sendHint: 'Pulsa Intro para enviar, Mayús+Intro para un salto de línea.', send: 'Enviar', loading: 'Conectando…', offline: 'Chat no disponible. Escribe a Desk@eurolicenze.com', retry: 'Reconectando…', error: 'Mensaje no enviado. Inténtalo de nuevo.', close: 'Cerrar chat', open: 'Abrir el chat de soporte', stOnline: 'En línea', stOffline: 'Sin conexión', stConnecting: 'Conectando…', stReconnecting: 'Reconectando…', stError: 'No disponible', noticeOnline: 'Soporte en línea. Solemos responder en pocos minutos.', noticeOffline: 'Estamos sin conexión (soporte Lun–Sáb, 08:00–19:00 CET/CEST). Deja tu nombre, email y un mensaje: te responderemos.' },
        nl: { launcher: 'Chat', title: 'Eurolicenze ondersteuning', intro: 'Hoe kunnen we helpen?', name: 'Naam', email: 'E-mail', placeholder: 'Schrijf een bericht…', sendHint: 'Druk op Enter om te verzenden, Shift+Enter voor een nieuwe regel.', send: 'Verzenden', loading: 'Verbinden…', offline: 'Chat niet beschikbaar. Mail naar Desk@eurolicenze.com', retry: 'Opnieuw verbinden…', error: 'Bericht niet verzonden. Probeer het opnieuw.', close: 'Chat sluiten', open: 'Open de ondersteuningschat', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'Verbinden…', stReconnecting: 'Opnieuw verbinden…', stError: 'Niet beschikbaar', noticeOnline: 'Ondersteuning is online. We reageren meestal binnen enkele minuten.', noticeOffline: 'We zijn offline (ondersteuning ma–za, 08:00–19:00 CET/CEST). Laat je naam, e-mail en een bericht achter: we nemen zo snel mogelijk contact op.' },
        pt: { launcher: 'Chat', title: 'Suporte Eurolicenze', intro: 'Como podemos ajudar?', name: 'Nome', email: 'Email', placeholder: 'Escreva uma mensagem…', sendHint: 'Prima Enter para enviar, Shift+Enter para uma nova linha.', send: 'Enviar', loading: 'A ligar…', offline: 'Chat indisponível. Escreva para Desk@eurolicenze.com', retry: 'A reconectar…', error: 'Mensagem não enviada. Tente novamente.', close: 'Fechar chat', open: 'Abrir o chat de suporte', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'A ligar…', stReconnecting: 'A reconectar…', stError: 'Indisponível', noticeOnline: 'O suporte está online. Normalmente respondemos em poucos minutos.', noticeOffline: 'Estamos offline (suporte Seg–Sáb, 08:00–19:00 CET/CEST). Deixe o seu nome, email e uma mensagem: entraremos em contacto assim que possível.' },
    };
