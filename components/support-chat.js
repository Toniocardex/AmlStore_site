(function () {
    ...
    const COPY = {
        ...
        nl: { launcher: 'Chat', title: 'Aml Store ondersteuning', intro: 'Hoe kunnen we helpen?', name: 'Naam', email: 'E-mail', placeholder: 'Schrijf een bericht…', sendHint: 'Druk op Enter om te verzenden, Shift+Enter voor een nieuwe regel.', send: 'Verzenden', loading: 'Verbinden…', offline: 'Chat niet beschikbaar. Mail naar info@amlstore.it', retry: 'Opnieuw verbinden…', error: 'Bericht niet verzonden. Probeer het opnieuw.', close: 'Chat sluiten', open: 'Open de ondersteuningschat', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'Verbinden…', stReconnecting: 'Opnieuw verbinden…', stError: 'Niet beschikbaar', noticeOnline: 'Ondersteuning is online. We reageren meestal binnen enkele minuten.', noticeOffline: 'We zijn offline (ondersteuning ma–za, 08:00–19:00 CET/CEST). Laat je naam, e-mail en een bericht achter: we nemen zo snel mogelijk contact op.' },
        pt: { launcher: 'Chat', title: 'Suporte Aml Store', intro: 'Como podemos ajudar?', name: 'Nome', email: 'Email', placeholder: 'Escreva uma mensagem…', sendHint: 'Prima Enter para enviar, Shift+Enter para uma nova linha.', send: 'Enviar', loading: 'A ligar…', offline: 'Chat indisponível. Escreva para info@amlstore.it', retry: 'A reconectar…', error: 'Mensagem não enviada. Tente novamente.', close: 'Fechar chat', open: 'Abrir o chat de suporte', stOnline: 'Online', stOffline: 'Offline', stConnecting: 'A ligar…', stReconnecting: 'A reconectar…', stError: 'Indisponível', noticeOnline: 'O suporte está online. Normalmente respondemos em poucos minutos.', noticeOffline: 'Estamos offline (suporte Seg–Sáb, 08:00–19:00 CET/CEST). Deixe o seu nome, email e uma mensagem: entraremos em contacto assim que possível.' },
    };
