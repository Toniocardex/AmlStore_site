...
PRODUCTS = {
    ...
    "windows-11-pro-oem-dvd": {
        ...
        "features": {
            "it": [
                ("c12", "blue", "Formato", "OEM + DVD", "Windows 11 Pro OEM con supporto DVD fisico: edizione Pro e media come descritto in scheda — non è una licenza solo ESD."),
                ("c6", "purple", "Consegna", "Spedizione gratuita", "Articolo fisico: spedizione express gratuita in 24 ore dopo il pagamento. Conferma ordine via email."),
                ("c6", None, "Attivazione", "Canali Microsoft", "Attivi Windows con la licenza/codice dell'ordine, secondo le istruzioni ricevute."),
                ("c6", None, "Hardware", "Requisiti Win11", "Verifica CPU, TPM e Secure Boot prima dell'installazione."),
                ("c6", "dark", "Nota OEM", "Condizioni OEM", "Le OEM hanno regole Microsoft su dispositivo e trasferimento: leggi email e termini."),
            ],
            "en": [
                ("c12", "blue", "Format", "OEM + DVD", "Windows 11 Pro OEM with physical DVD media as described—not a digital-only ESD licence."),
                ("c6", "purple", "Delivery", "Free shipping", "Physical item: free dispatch within 48 hours after payment. Order confirmation by email."),
                ("c6", None, "Activation", "Microsoft channels", "Activate Windows with the licence/key from your order, following the instructions received."),
                ("c6", None, "Hardware", "Win11 requirements", "Check CPU, TPM and Secure Boot before installing."),
                ("c6", "dark", "OEM note", "OEM terms", "OEM has specific Microsoft rules on devices and transfer—read email and terms."),
            ],
            "fr": [
                ("c12", "blue", "Format", "OEM + DVD", "Windows 11 Pro OEM avec DVD physique — pas une licence ESD uniquement numérique."),
                ("c6", "purple", "Livraison", "Livraison gratuite", "Article physique : expédition gratuite sous 48 heures après paiement. Confirmation de commande par e-mail."),
                ("c6", None, "Activation", "Canaux Microsoft", "Activation avec licence/clé de la commande et instructions reçues."),
                ("c6", None, "Matériel", "Exigences Win11", "Vérifiez CPU, TPM et Secure Boot."),
                ("c6", "dark", "Note OEM", "Conditions OEM", "Règles Microsoft sur appareil et transfert — lisez e-mail et conditions."),
            ],
            "de": [
                ("c12", "blue", "Format", "OEM + DVD", "Windows 11 Pro OEM mit physischer DVD — keine reine ESD-Lizenz."),
                ("c6", "purple", "Lieferung", "Kostenloser Versand", "Physischer Artikel: kostenloser Versand innerhalb von 48 Stunden nach Zahlung. Bestellbestätigung per E-Mail."),
                ("c6", None, "Aktivierung", "Microsoft-Kanäle", "Aktivierung mit Lizenz/Key der Bestellung laut Anleitung."),
                ("c6", None, "Hardware", "Win11-Anforderungen", "CPU, TPM und Secure Boot prüfen."),
                ("c6", "dark", "OEM-Hinweis", "OEM-Bedingungen", "Microsoft-Regeln zu Gerät und Übertragung — E-Mail und AGB lesen."),
            ],
            "es": [
                ("c12", "blue", "Formato", "OEM + DVD", "Windows 11 Pro OEM con DVD físico: no es una licencia solo ESD digital."),
                ("c6", "purple", "Entrega", "Envío gratuito", "Artículo físico: envío gratuito en 48 horas tras el pago. Confirmación del pedido por email."),
                ("c6", None, "Activación", "Canales Microsoft", "Activa con la licencia/clave del pedido según las instrucciones."),
                ("c6", None, "Hardware", "Requisitos Win11", "Comprueba CPU, TPM y Secure Boot."),
                ("c6", "dark", "Nota OEM", "Condiciones OEM", "Reglas Microsoft sobre dispositivo y transferencia: lee email y términos."),
            ],
        },
        "lifestyle": {
            ...
            "height": 400,
            "alt": L(
                it="Confezione Windows 11 Pro OEM con supporto DVD.",
                en="Windows 11 Pro OEM packaging with DVD media.",
                fr="Boîtier Windows 11 Pro OEM avec support DVD.",
                de="Windows 11 Pro OEM-Verpackung mit DVD.",
                es="Packaging Windows 11 Pro OEM con soporte DVD.",
            ),
            "kicker": L(
                it="Supporto fisico",
                en="Physical media",
            ...
            "title": L(
                it="DVD OEM, non solo codice email",
                en="OEM DVD—not email-only",
                fr="DVD OEM, pas seulement un code e-mail",
                de="OEM-DVD — nicht nur E-Mail-Key",
                es="DVD OEM, no solo código por email",
            ),
            "body": L(
                it="Ricevi istruzioni via email e il supporto DVD secondo la spedizione indicata in checkout. Attivazione sui canali Microsoft.",
                en="Email instructions plus DVD media shipped as shown at checkout. Activate via Microsoft channels.",
                fr="Instructions par e-mail et DVD expédié selon le checkout. Activation via Microsoft.",
                de="Anleitung per E-Mail und DVD laut Checkout-Versand. Aktivierung über Microsoft.",
                es="Instrucciones por email y DVD según el envío del checkout. Activación vía Microsoft.",
            ),
        },
        "apps_title": L(it="", en="", fr="", de="", es=""),
        "faq": {
            "it": [
                ("Cosa ricevo?", "Il supporto DVD fisico con spedizione gratuita express in 24 ore, più conferma d'ordine via email. Poi attivi Windows sui canali Microsoft."),
                ("È diversa dalla Pro ESD?", "Sì: questa scheda è OEM con DVD spedito; la Pro ESD è solo digitale. Confronta le schede."),
                ("Come si attiva?", "Con la licenza/codice associati all'ordine, sui canali Microsoft."),
            ...
            "en": [
                ("What do I receive?", "Physical DVD media with free shipping within 48 hours, plus order confirmation by email. Then activate Windows via Microsoft channels."),
                ("Different from Pro ESD?", "Yes—this page is OEM with shipped DVD; Pro ESD is digital-only. Compare pages."),
                ("How do I activate?", "With the licence/key for your order, via Microsoft channels."),
            ...
            "fr": [
                ("Que vais-je recevoir ?", "Le DVD physique en livraison gratuite sous 48 heures, plus confirmation de commande par e-mail. Puis activation via Microsoft."),
                ("Différent de Pro ESD ?", "Oui — OEM avec DVD expédié ; Pro ESD est 100 % numérique."),
                ("Activation ?", "Avec la licence/clé de la commande, via Microsoft."),
                ("Exigences PC ?", "Comme Windows 11 — compatibilité Microsoft."),
                ("Transfert de licence ?", "Limites OEM spécifiques — conditions Microsoft."),
            ],
            "de": [
                ("Was erhalte ich?", "Physische DVD mit kostenlosem Versand innerhalb von 48 Stunden sowie Bestellbestätigung per E-Mail. Danach Aktivierung über Microsoft."),
                ("Anders als Pro ESD?", "Ja — OEM mit versendeter DVD; Pro ESD ist rein digital."),
                ("Aktivierung?", "Mit Lizenz/Key der Bestellung über Microsoft."),
            ...
            "es": [
                ("¿Qué recibo?", "El DVD físico con envío gratuito en 48 horas, más confirmación del pedido por email. Luego activas Windows vía Microsoft."),
                ("¿Es distinto de Pro ESD?", "Sí: OEM con DVD enviado; Pro ESD es solo digital."),
                ("¿Cómo se activa?", "Con la licencia/clave del pedido, vía Microsoft."),
    ...
    "windows-11-pro-coa": {
        ...
        "faq": {
            "it": [
                ("Cos'è il COA?", "Certificate of Authenticity: sticker fisico OEM spedito a domicilio (spedizione gratuita express in 24 ore), con conferma ordine via email."),
            ...
            "en": [
                ("What is the COA?", "Certificate of Authenticity—physical OEM sticker shipped free within 48 hours, plus order confirmation by email."),
            ...
            "fr": [
                ("Qu'est-ce que le COA ?", "Certificate of Authenticity — sticker OEM physique expédié gratuitement sous 48 heures, plus confirmation de commande par e-mail."),
            ...
            "de": [
                ("Was ist COA?", "Certificate of Authenticity — physischer OEM-Sticker mit kostenlosem Versand innerhalb von 48 Stunden sowie Bestellbestätigung per E-Mail."),
            ...
            "es": [
                ("¿Qué es el COA?", "Certificate of Authenticity: pegatina OEM física con envío gratuito en 48 horas, más confirmación del pedido por email."),
