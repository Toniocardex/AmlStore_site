...
PRODUCTS["project-professional-2024"] = _project_or_visio(
    ...
    True,
    {
        ...
        "seo_title": L(
            it="Project Professional 2024 — licenza perpetua ESD | Eurolicenze",
            en="Project Professional 2024 — perpetual ESD licence | Eurolicenze",
            fr="Project Professional 2024 — licence ESD perpétuelle | Eurolicenze",
            de="Project Professional 2024 — ESD-Dauerlizenz | Eurolicenze",
            es="Project Professional 2024 — licencia ESD perpetua | Eurolicenze",
            pt="Project Professional 2024 — licença perpétua ESD | Eurolicenze",
            nl="Project Professional 2024 — permanente ESD-licentie | Eurolicenze",
        ),
        "desc": L(
