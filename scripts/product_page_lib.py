...
BASE_LABELS = {
    ...
    "pt": {
        ...
        "step_checkout": "Checkout seguro",
        "step_email": "Email",
        "step_email_desc": "Código e instruções em 2–15 minutos",
        "step_act": "Ativação",
        "desc_suffix": "Licença digital original, entrega por email em 2–15 minutos.",
    },
    "nl": {
        ...
        "tax": "Inclusief belastingen.",
        "sticky": "Snel kopen",
        "steps_title": "Levering en activering",
        "step_order": "Bestelling",
        "step_checkout": "Veilig afrekenen",
        "step_email": "E-mail",
        "step_email_desc": "Code en instructies binnen 2–15 minuten",
        "step_act": "Activering",
        "desc_suffix": "Originele digitale licentie, levering per e-mail binnen 2–15 minuten.",
    },
}
...
BUY_LABELS = {
    "it": {"avail": "Disponibile", "eta": "Email in 2–15 min",
           "plan": "Seleziona la versione", "checkout": "Acquista ora",
           "sticky_delivery": "Consegna in 2–15 min via Email"},
    "en": {"avail": "In stock", "eta": "Email in 2–15 min",
           "plan": "Choose your edition", "checkout": "Buy now",
           "sticky_delivery": "Delivered in 2–15 min by email"},
    "fr": {"avail": "Disponible", "eta": "E-mail en 2–15 min",
           "plan": "Choisissez la version", "checkout": "Acheter maintenant",
           "sticky_delivery": "Livraison en 2–15 min par e-mail"},
    "de": {"avail": "Verfügbar", "eta": "E-Mail in 2–15 Min.",
           "plan": "Version auswählen", "checkout": "Jetzt kaufen",
           "sticky_delivery": "Lieferung in 2–15 Min. per E-Mail"},
    "es": {"avail": "Disponible", "eta": "Email en 2–15 min",
           "plan": "Selecciona la versión", "checkout": "Comprar ahora",
           "sticky_delivery": "Entrega en 2–15 min por email"},
    "pt": {"avail": "Disponível", "eta": "Email em 2–15 min",
           "plan": "Escolha a versão", "checkout": "Comprar agora",
           "sticky_delivery": "Entrega em 2–15 min por email"},
    "nl": {"avail": "Beschikbaar", "eta": "E-mail in 2–15 min",
           "plan": "Kies uw editie", "checkout": "Nu kopen",
           "sticky_delivery": "Levering in 2–15 min per e-mail"},
}
...
<body class="pdp-page">
    ...
    <div id="product-sticky-cta" class="product-sticky-cta" role="region" aria-label="{labels['sticky']}" aria-hidden="true">
        <div class="product-sticky-cta__inner">
            ...
            <button type="button" class="btn-primary" data-cart-add data-cart-source="product-pricing">
                {CART_ICON}
                {labels['add']}
            </button>
        </div>
