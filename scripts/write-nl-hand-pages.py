...
EN_NL = [
    ...
    ("Receive your official licence code and instructions within 2–15 minutes of purchase.",
     "Ontvang uw officiële licentiecode en instructies binnen 2–15 minuten na aankoop."),
